...
<body>
    ...
    <header class="navbar navbar-default" id="bjui-header">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.genobien.com" target="_blank"><img src="res/images/logo_1.png" ></a>
        </div>
                ...
                <div class="page unitBox">
                    <div class="bjui-pageHeader" style="background:#FFF;">
                        <div style="padding: 0 5px;">
                            ...
                            <h4 style="margin-bottom:20px;">欢迎使用GENOBIEN健诺嘉卡密微商城程序&nbsp;<small>最好用的卡密微商城程序</small></h4>
                            </div>
                        </div>
                    </div>
